      ...
      <main className='relative z-10 pt-24 pb-20 min-h-[calc(100vh-160px)]'>
        <div className='max-w-[800px] mx-auto px-6'>
          ...
          <div className='text-center mb-10'>
            ...
            <p className='font-body-md text-on-surface-variant mx-auto text-center'>
              Know a trusted Indian PC retailer we missed? Let us know so we can add them to our
              pricing engine.
            </p>
          </div>
            ...
            <form className='space-y-6'>
              ...
              <div>
                <label className='block font-body-sm font-medium text-on-surface mb-1.5'>
                  ...
                  <span className='font-normal text-on-surface-variant ml-1'>(Optional)</span>
                </label>
