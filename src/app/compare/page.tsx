      ...
      <div className='max-w-[1280px] mx-auto px-6 py-12'>
        <div className='mb-8 flex items-end justify-between'>
          <div>
            ...
            <p className='font-body-sm text-on-surface-variant'>
              Side-by-side technical specifications and real-time pricing.
            </p>
          </div>
          {products.length > 0 && (
            <Button
        ...
        {products.length === 0 ? (
          ...
          <div className='bg-surface-container-lowest border border-surface-container-high rounded-2xl p-16 flex flex-col items-center justify-center text-center'>
            ...
            <p className='font-body-sm text-on-surface-variant mx-auto text-center mb-6'>
              Select up to 4 components from our product listings to analyze them side-by-side.
            </p>
            <Button
              variant='outline'
              asChild
          ...
          <div className='relative bg-surface-container-lowest border border-surface-container-high rounded-2xl overflow-x-auto shadow-sm'>
            <div className='min-w-[800px]'>
              {/* Sticky Header */}
              <div
                className={`grid ${gridColumnsClass} sticky top-16 z-40 bg-surface/95 backdrop-blur-md border-b border-surface-container-high p-4`}
              >
                ...
                {products.map(product => (
                  <div
                    key={product.id}
                    className='p-4 flex flex-col border border-surface-container-high rounded-xl bg-surface-container-lowest mx-2'
                  >
                    ...
                    <div className='mt-auto'>
                      <p className='font-label-md text-[10px] text-on-surface-variant uppercase mb-1'>
                        Lowest Price
                      </p>
                    ...
                    >
                      ...
                      {products.map(product => (
                        <div
                          ...
                          className='p-4 px-6 flex items-center font-body-sm text-on-surface tabular-nums border-r border-surface-container-high/50 last:border-r-0'
                        >
